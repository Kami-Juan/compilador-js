...
let generarCodigoIntermedio = ( tabla_lexico, errores_semanticos ) =>
{
        ...
        //AQUI MISMO OPTIMIZA EL CODIGO BORRANDO LAS SUMA Y RESTAS CON CERO
        ...
        //AQUI SE OBTIENEN LAS FILAS TANTO DE LOS QUE ESTAN DENTRO DEL DO Y EL WHILE
        let pos_do = obtener_pos_do( tabla_lexico_optimizado );
        let pos_while = obtener_pos_while( tabla_lexico_optimizado );


        //SE OBTIENEN LAS POSICIONES FINALES DE LAS FILAS DE INICIO
        let pos_final_do = [];
        ...
        //SE OBTIENEN LAS POSICIONES FINALES DE LOS WHILE
        let pos_final_while = [];
        ...
        /*----------------------------------------------------*/
        //OBTIENE LAS FILAS POR CADA DO EXISTENTE
        ...
        //OBTIENE LAS FILAS POR CADA WHILE EXISTENTE
        ...
        /*--------------------------------------------------*/
        //SETEA LOS POST EN CADA FILA DE DO
        ...
        //OBTIENE LAS LINEAS DE CODIGO EN FORMATO POSTFIJO WHILE
        ...
        //CREA LAS TABLAS DE CODIGO INTERMEDIO DE DO
        ...
        //GUARDA LAS TABLAS EN EL ARREGLO TABLAS_FINALES _CODE_INTERMEDIO_DO
        ...
        //GUARDA LAS TABLAS EN EL ARREGLO TABLAS_FINALES _CODE_INTERMEDIO_WHILE
...
//LIMPIA LAS PILAS DE RESULTADOS DESPUÈS DE SU EJECUCIÒN
